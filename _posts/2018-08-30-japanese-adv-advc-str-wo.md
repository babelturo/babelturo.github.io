...
### 부사와 부사절의 계층 구조
일본어는 술부는 계층 구조를 가지고 있다. 어간을 기준으로 태(voice), 상(aspect), 긍정 혹은 부정, 시제(tense), 대사적인 무드(対事的ムード), 대인적인 무드(対人的ムード)의 순서로 배열된다. 예를 들면 '書かれていなかったらしいよ'의 경우 아래의 표와 같은 나타낼 수 있다.
